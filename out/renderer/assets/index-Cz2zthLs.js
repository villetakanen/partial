...
var root$3 = /* @__PURE__ */ from_html(`<section class="gantt-view svelte-80wpic"><p class="placeholder svelte-80wpic"> </p></section>`);
function Gantt($$anchor, $$props) {
  ...
  var p = child(section);
  var text = child(p);
  template_effect(() => set_text(text, `Gantt view — ${get(taskCount) ?? ""} tasks, ${get(edgeCount) ?? ""} dependencies`));
  append($$anchor, section);
  pop();
}
var root$2 = /* @__PURE__ */ from_html(`<section class="graph-view svelte-17lrwva"><p class="placeholder svelte-17lrwva"> </p></section>`);
function Graph($$anchor, $$props) {
  ...
  var p = child(section);
  var text = child(p);
  template_effect(() => set_text(text, `Graph view — ${get(taskCount) ?? ""} tasks, ${get(edgeCount) ?? ""} dependencies`));
  append($$anchor, section);
  pop();
}
var root$1 = /* @__PURE__ */ from_html(`<section class="kanban-view svelte-kubzvj"><p class="placeholder svelte-kubzvj"> </p></section>`);
function Kanban($$anchor, $$props) {
  ...
  var p = child(section);
  var text = child(p);
  template_effect(() => set_text(text, `Kanban view — ${get(taskCount) ?? ""} tasks, ${get(edgeCount) ?? ""} dependencies`));
  append($$anchor, section);
  pop();
}
var root = /* @__PURE__ */ from_html(`<main class="svelte-1la1gos"><header class="svelte-1la1gos"><h1 class="svelte-1la1gos">Partial</h1> <nav class="svelte-1la1gos"><button>Gantt</button> <button>Kanban</button> <button>Graph</button></nav></header> <section class="view-container svelte-1la1gos"><!></section></main>`);
function App($$anchor, $$props) {
  push($$props, true);
  let view = /* @__PURE__ */ state("gantt");
  const emptyPlan = { version: "1.0.0", project: "", tasks: [] };
  let plan = /* @__PURE__ */ state(proxy(emptyPlan));
  ...
  template_effect(() => {
    classes = set_class(button, 1, "svelte-1la1gos", null, classes, { active: get(view) === "gantt" });
    classes_1 = set_class(button_1, 1, "svelte-1la1gos", null, classes_1, { active: get(view) === "kanban" });
    classes_2 = set_class(button_2, 1, "svelte-1la1gos", null, classes_2, { active: get(view) === "graph" });
  });
  append($$anchor, main);
  pop();
}
